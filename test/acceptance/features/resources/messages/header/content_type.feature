...
Feature: Content-Type entity-header field
    ...
    Scenario Outline: Valid content-type field.
        ...
        "     "key": "7543ccef-a41a-4eb6-b138-6a66402d2b96"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "7543ccef-a41a-4eb6-b138-6a66402d2b96" ] "
        "   }                                                      "
        " }                                                        "
        """
    ...
    Scenario Outline: Abscent content-type field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/messages" with headers "Accept: application/json, Host: localhost:1984":
        """
        " { data } "
        """
    ...
    Scenario Outline: Empty content-type field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: , Accept: application/json, Host: localhost:1984":
        """
        " { data } "
        """
        Then I should see a response status code of "415" "Unsupported Media Type"
