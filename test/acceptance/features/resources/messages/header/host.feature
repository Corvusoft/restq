...
Feature: Host request-header field
    ...
    Scenario Outline: Valid IPv4 host request-header field.
        ...
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: 127.0.0.1":
        """
        " ftp://localhost/reading "
        """
        Then I should see a response status code of "202" "Accepted"
    ...
    Scenario Outline: Valid IPv4 with port host request-header field.
        ...
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: 127.3.3.1:8483":
        """
        " ftp://localhost/reading "
        """
        Then I should see a response status code of "202" "Accepted"
    ...
    Scenario Outline: Valid IPv6 host request-header field.
        ...
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: [2001:db8:a0b:12f0::1]":
        """
        " ftp://localhost/reading "
        """
        Then I should see a response status code of "202" "Accepted"
    ...
    Scenario Outline: Valid IPv6 with port host request-header field.
        ...
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: [2001:0db8:0a0b:12f0:0000:0000:0000:0001]:98":
        """
        " ftp://localhost/reading "
        """
        Then I should see a response status code of "202" "Accepted"
