...
Feature: Content-MD5 entity-header field
    ...
    Scenario Outline: Valid uppercase content-md5 entity-header field.
        ...
        "     "key": "5dad03c1-95c3-437c-8222-6b5fa263935f"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "5dad03c1-95c3-437c-8222-6b5fa263935f" ] "
        "   }                                                      "
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984, Content-MD5: B04788867E97CCC25D68E1A3204173BE":
        """
    ...
    Scenario Outline: Valid lowercase content-md5 entity-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "1cf9b39a-6ce7-46ed-a33c-fd7d0bafc456"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "1cf9b39a-6ce7-46ed-a33c-fd7d0bafc456" ] "
        "   }                                                      "
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984, Content-MD5: f56cd924be65dc55e955d54910971407":
        """
        " ftp://localhost/message "
        """
        Then I should see a response status code of "202" "Accepted"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: Valid mixedcase content-md5 entity-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "93cd3c94-8e08-477e-b599-0bff561a12dd"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "93cd3c94-8e08-477e-b599-0bff561a12dd" ] "
        "   }                                                      "
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984, Content-MD5: 158D954bA8Bf57184bc62181a442DC50":
        """
        " ftp://localhost/msgs "
        """
        Then I should see a response status code of "202" "Accepted"
    ...
    Scenario Outline: Invalid content-md5 entity-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "48e14b38-aedd-4ee4-847a-7f309121efd5"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "48e14b38-aedd-4ee4-847a-7f309121efd5" ] "
        "   }                                                      "
        " }                                                        "
        """
        When I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984, Content-MD5: 7D90111F7A4B6738AFA860BE3D2ECF30":
        """
        " ftp://localhost/reading "
        """
