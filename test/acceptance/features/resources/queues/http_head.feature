...
Feature: HTTP HEAD
    ...
    Scenario Outline: Read collection meta-data with single entry.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read collection meta-data with multiple entries.
        ...
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "361"
        And I should see a "Content-MD5" header value
        And I should see a "Connection" header value "close"
        And I should see a "Date" header value
        And I should see a "ETag" header value
