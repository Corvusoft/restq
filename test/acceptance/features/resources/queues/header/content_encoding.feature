...
Feature: Content-Encoding entity-header field
    ...
    Scenario Outline: Valid content-encoding field.
        ...
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Encoding: identity":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Invalid content-encoding field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Encoding: gzip":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Empty content-encoding field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Encoding: ":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
