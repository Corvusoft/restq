...
Feature: Content-Length entity-header field
    ...
    Scenario Outline: Valid content-length field.
        ...
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: 208":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Invalid content-length field; too small.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: 3":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Invalid content-length field; too large.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: 98700":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Abscent content-length field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with only headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Zero content-length field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: 0":
        """
        """
        Then I should see a response status code of "400" "Bad Request"
        And I should see a "Server" header value "corvusoft/restq"
    ...
    Scenario Outline: Empty content-length field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: ":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Malformed content-length field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Content-Length: lkajfw098":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
