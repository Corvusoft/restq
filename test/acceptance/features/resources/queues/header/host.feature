...
Feature: Host request-header field
    ...
    Scenario Outline: Invalid host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: Mount Eden Auckland NZ":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Abscent host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Empty host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: ":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Valid IPv4 host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: 123.123.123.45":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Valid IPv4 with port host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: 123.123.123.45:1":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Valid IPv6 host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: [2001:cdba::3257:9652]":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
    ...
    Scenario Outline: Valid IPv6 with port host request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/queues" with headers "Content-Type: application/json, Accept: application/json, Host: [2001:cdba::3257:9652]:7":
        """
        " { "data": {                                        "
        "     "name": "acceptance-test"                      "
        "   }                                                "
