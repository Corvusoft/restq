...
Feature: If-Range request-header field
    ...
    Scenario Outline: ETag if-range request-header field.
        ...
        When I perform a HTTP "OPTIONS" request to "/*" with headers "Accept: application/json, Host: localhost:1984, If-Range: "12978507194598101300", Range: bytes=3744-"
    ...
    Scenario Outline: Date if-range request-header field.
        Given I have started a message exchange
        When I perform a HTTP "OPTIONS" request to "/*" with headers "Accept: application/json, Host: localhost:1984, If-Range: Sat, 29 Oct 1994 19:43:31 GMT, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Workers" header value
        And I should see a "Uptime" header value
        And I should see a "CPU" header value
    ...
    Scenario Outline: Wildcard if-range request-header field.
        Given I have started a message exchange
        When I perform a HTTP "OPTIONS" request to "/*" with headers "Accept: application/json, Host: localhost:1984, If-Range: *, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Workers" header value
        And I should see a "Uptime" header value
        And I should see a "CPU" header value
