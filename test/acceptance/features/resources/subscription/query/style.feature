...
Feature: Styled Output
    ...
    Scenario Outline: Read resource with styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/311af898-4406-47f0-8488-b3da7d6d3f6d?style=on" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "294"
    ...
    Scenario Outline: Read resource without styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/24c0f4e3-bfc3-421b-9743-390ff1b9d8e2?style=off" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        ...
        And I should see a response body describing the resource:
        """
        " {"data":{"key":"24c0f4e3-bfc3-421b-9743-390ff1b9d8e2","type":"subscription","endpoint":"http://localhost:8080"}} "
        """
    ...
    Scenario Outline: Update resource with styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/24fc0ee1-70a7-4009-a7b9-49fc03dac75d?style=true" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        ...
        And I should see a "Content-MD5" header value
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Length" header value "292"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: Update resource without styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/947460fb-1f7f-464e-9bf8-9c8327586be3?style=false" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
        ...
        And I should see a response body describing the resource:
        """
        " {"data":{"key":"947460fb-1f7f-464e-9bf8-9c8327586be3","endpoint":"http://localhost:80","type":"subscription"}} "
        """
    ...
    Scenario Outline: HTTP error with styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "TRACE" request to "/subscriptions/c32f6818-4e5f-4215-bb26-d1d99293bc51?style=1" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: HTTP error without styling.
        ...
        " }                                                  "
        """
        When I perform a HTTP "TRACE" request to "/subscriptions/817ae63e-6c27-429d-b7d0-0aedbf21a62a?style=0" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "501" "Not Implemented"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
