...
Feature: HTTP CONNECT
    ...
    Scenario Outline: Connect resource.
        ...
        """
        " { "data": {                                        "
        "     "key": "b48f4382-e0dc-4af0-ab72-eeb6913f28f3", "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
        " }                                                  "
        """
        When I perform a HTTP "CONNECT" request to "/subscriptions/b48f4382-e0dc-4af0-ab72-eeb6913f28f3" with headers "Accept: application/json, Host: localhost:1984"
