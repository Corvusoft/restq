...
Feature: If-None-Match request-header field
    ...
    Scenario Outline: ETag if-none-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/0566df30-7a8b-486a-836c-d861aeb57267" with headers "Accept: application/json, Host: localhost:1984, If-None-Match: "12978507193598101300""
    ...
    Scenario Outline: Wildcard if-none-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/c5b9d302-7e24-4e4a-96ad-6eaf8b7459a9" with headers "Accept: application/json, Host: localhost:1984, If-None-Match: *"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "232"
    ...
    Scenario Outline: Empty if-none-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/8f263bba-c2a6-4fbd-9fc9-cb078c5c625e" with headers "Accept: application/json, Host: localhost:1984, If-None-Match: "
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "232"
