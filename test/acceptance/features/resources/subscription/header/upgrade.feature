...
Feature: Upgrade general-header field
    ...
    Scenario Outline: Upgrade general-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/a46ab5ff-747c-4da8-94dd-f184578a9160" with headers "Accept: application/json, Host: localhost:1984, Connection: upgrade, Upgrade: h2c"
