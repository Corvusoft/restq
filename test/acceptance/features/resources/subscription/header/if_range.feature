...
Feature: If-Range request-header field
    ...
    Scenario Outline: ETag if-range request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/fff3fbcd-851c-4b2d-866a-dc1c195bfe1b" with headers "Accept: application/json, Host: localhost:1984, If-Range: "12978507193598101300", Range: bytes=3744-"
    ...
    Scenario Outline: Date if-range request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/ed6b1b7b-d715-408f-af05-5f4df4bc5d73" with headers "Accept: application/json, Host: localhost:1984, If-Range: Sat, 29 Oct 1994 19:43:31 GMT, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "212"
    ...
    Scenario Outline: Wildcard if-range request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/246e1918-6b45-4283-a480-8ef30e821705" with headers "Accept: application/json, Host: localhost:1984, If-Range: *, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "212"
    ...
    Scenario Outline: Empty if-range request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/e51dae2c-314c-4333-b350-ee16e312546f" with headers "Accept: application/json, Host: localhost:1984, If-Range: , Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "212"
