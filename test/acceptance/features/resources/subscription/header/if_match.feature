...
Feature: If-Match request-header field
    ...
    Scenario Outline: ETag if-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/964f1866-d52c-4bee-986e-161ca8858001" with headers "Accept: application/json, Host: localhost:1984, If-Match: "12978507193598101300""
    ...
    Scenario Outline: Wildcard if-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/70603b83-0a31-4798-8643-1f576cc3ebc6" with headers "Accept: application/json, Host: localhost:1984, If-Match: *"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "212"
    ...
    Scenario Outline: Empty if-match request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/08bd3c35-17c1-4f48-8e87-4c4ed9e63335" with headers "Accept: application/json, Host: localhost:1984, If-Match: "
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "212"
