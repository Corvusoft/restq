...
Feature: Content-Length entity-header field
    ...
    Scenario Outline: Valid content-length field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/417c6444-6050-46ec-9329-60fd5e31a44d" with headers "Content-Type: application/json, Accept: application/json, Content-Length: 156, Host: localhost:1984":
        """
        " { "data": {                           "
    ...
    Scenario Outline: Invalid content-length field; too small.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/a0c329e6-7662-4625-9be0-0344e24c8d75" with headers "Content-Type: application/json, Accept: application/json, Content-Length: 3, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Invalid content-length field; too large.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/e867b0ce-4e6f-4169-973d-fe1d173eaaf0" with headers "Content-Type: application/json, Accept: application/json, Content-Length: 98700, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Abscent content-length field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/637e17c8-fa79-4652-89e0-b00ddd34f4b3" with only headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Zero content-length field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/ae33df87-bdce-4355-8112-6bf3f415fa51" with headers "Content-Type: application/json, Accept: application/json, Content-Length: 0, Host: localhost:1984":
        """
        """
        Then I should see a response status code of "400" "Bad Request"
        And I should see a "Server" header value "corvusoft/restq"
    ...
    Scenario Outline: Empty content-length field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/4c0809db-e950-413a-93da-e01302479df0" with headers "Content-Type: application/json, Accept: application/json, Content-Length: , Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Malformed content-length field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/364c13cc-91f1-4f9e-b478-36963fae91de" with headers "Content-Type: application/json, Accept: application/json, Content-Length: lkajfw098, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
