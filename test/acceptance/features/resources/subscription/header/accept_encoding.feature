...
Feature: Accept-Encoding request-header field
    ...
    Scenario Outline: Valid accept-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/1638c528-be58-4b2d-8b1d-43f77a265c59" with headers "Accept: application/json, Accept-Encoding: identity, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/7d1a7f5e-4c1a-41aa-adcd-bc0243b3940f" with headers "Accept: application/json, Accept-Encoding: gzip, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/e67ed5c6-46f6-4afe-bfeb-bceeb3826e08" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "232"
    ...
    Scenario Outline: Empty accept-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/877f3446-497f-4181-9bf8-442010fc6361" with headers "Accept: application/json, Accept-Encoding: , Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "232"
    ...
    Scenario Outline: Wildcard accept-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/03dac99c-0707-4af5-94f3-bee74cb54559" with headers "Accept: application/json, Accept-Encoding: *, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "232"
