...
Feature: Last-Modified entity-header field
    ...
    Scenario Outline: Update resource.
        ...
        When I perform a HTTP "PUT" request to "/subscriptions/24517b76-c91e-40c0-a5b7-d167c6b6c420" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
    ...
    Scenario Outline: Update resource with no change required.
        ...
        """
        And I wait "10" seconds
        When I perform a HTTP "PUT" request to "/subscriptions/4b570eb4-bc1c-4be6-b9a5-cc038ce0f5bf" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                             "
        "     "endpoint": "http://localhost:8080" "
        "   }                                     "
