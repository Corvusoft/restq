...
Feature: Expect request-header field
    ...
    Scenario Outline: Valid expect request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/46bd2666-7e8f-439c-b44d-232e7ce8f3f9" with headers "Accept: application/json, Host: localhost:1984, Expect: 100-continue"
    ...
    Scenario Outline: Invalid expect request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/ee31ecad-7c32-4561-af0a-c49aeac175db" with headers "Accept: application/json, Host: localhost:1984, Expect: %^&*&!@(]^%$"
        Then I should see a response status code of "417" "Expectation Failed"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "193"
    ...
    Scenario Outline: Empty expect request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/e0f2a259-88cf-49bc-bc19-839fa874793a" with headers "Accept: application/json, Host: localhost:1984, Expect: "
        Then I should see a response status code of "417" "Expectation Failed"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "193"
