...
Feature: Transfer-Encoding general-header field
    ...
    Scenario Outline: Presense of transfer-encoding general-header field with content-length.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/651aa216-e9f2-48c8-b358-4515ec50514d" with headers "Content-Type: application/json, Accept: application/json, Content-Length: 156, Host: localhost:1984, Transfer-Encoding: chunked":
        """
        " { "data": {                           "
    ...
    Scenario Outline: Presense of transfer-encoding general-header field without content-length.
        ...
        """
        " { "data": {                                        "
        "     "key": "7b35fe20-7f7e-4ebd-93ae-6187934f1443", "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/7b35fe20-7f7e-4ebd-93ae-6187934f1443" with only headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Transfer-Encoding: chunked":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
