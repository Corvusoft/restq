...
Feature: Range request-header field
    ...
    Scenario Outline: HTTP GET range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/ca3a7855-73da-4f34-a8bd-d34eb165d8c0" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP HEAD range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions/ca727095-6cfd-468d-9b42-26b0af3ce023" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP CONNECT range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "CONNECT" request to "/subscriptions/a1c2ecf1-dc67-4801-a6a2-ee7a9acddd62" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP DELETE range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "DELETE" request to "/subscriptions/6db284e2-b2a2-4fe9-a2ac-56b2ade7826f" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: HTTP PATCH range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PATCH" request to "/subscriptions/fcfe99f8-a87c-4ccb-9237-96f117455e16" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "501" "Not Implemented"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "206"
    ...
    Scenario Outline: HTTP PUT resource with no change required, range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/351c5208-a9ea-46c2-b775-3514c6c2f891" with headers "Content-Type: application/json, Accept: application/json, Range: bytes=3744-, Host: localhost:1984":
        """
        " { "data": {                             "
        "     "endpoint": "http://localhost:8080" "
        "   }                                     "
    ...
    Scenario Outline: HTTP TRACE range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "TRACE" request to "/subscriptions/6d9fe6d3-c920-471c-856d-0aee92d67e68" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "501" "Not Implemented"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "206"
    ...
    Scenario Outline: HTTP POST range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "POST" request to "/subscriptions/23b5973f-2116-4872-bea9-c01620451b99" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Range: bytes=3744-":
        """
        " { "data": {                              "
    ...
    Scenario Outline: HTTP OPTIONS range field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "OPTIONS" request to "/subscriptions/449ab99c-8eed-4e5f-8bd3-c7ca5ccefa12" with headers "Accept: application/json, Host: localhost:1984, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Allow" header value "GET,PUT,HEAD,DELETE,OPTIONS"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
