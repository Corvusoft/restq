...
Feature: Content-Type entity-header field
    ...
    Scenario Outline: Valid content-type field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/8404c029-f184-4fd9-a0f8-52a02779f622" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
    ...
    Scenario Outline: Invalid content-type field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/e92fd26f-9d83-418f-a03f-208002643be4" with headers "Content-Type: application/xml, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Abscent content-type field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/68f399ba-adb0-4834-82f9-62f9b282f18f" with headers "Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
    ...
    Scenario Outline: Empty content-type field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "PUT" request to "/subscriptions/4ef6c657-748f-40f4-9e07-99a5bb642111" with headers "Content-Type: , Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                           "
        "     "endpoint": "http://localhost:80" "
        "   }                                   "
