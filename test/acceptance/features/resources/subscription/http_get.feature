...
Feature: HTTP GET
    ...
    Scenario Outline: Read resource.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/subscriptions/7c3cf0d2-7445-4132-a2e6-13895756a613" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read non-existent resource.
        Given I have started a message exchange
        When I perform a HTTP "GET" request to "/subscriptions/2b1456f3-0d64-4823-9922-923b655e22fe" with headers "Accept: application/json, Host: localhost:1984"
