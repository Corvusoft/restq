...
Feature: HTTP DELETE
    ...
    Scenario Outline: Delete resource.
        ...
        " }                                                  "
        """
        When I perform a HTTP "DELETE" request to "/subscriptions/3d64e183-a978-48ad-b110-fa67133a35ed" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Delete non-existent resource.
        Given I have started a message exchange
        When I perform a HTTP "DELETE" request to "/subscriptions/627e2cec-7a81-477a-bc33-2ba578c64f27" with headers "Accept: application/json, Host: localhost:1984"
