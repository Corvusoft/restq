...
Feature: HTTP HEAD
    ...
    Scenario Outline: Read resource meta-data.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/1177aed8-a024-445f-8560-dc0b478c04e9" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read non-existent resource meta-data.
        Given I have started a message exchange
        When I perform a HTTP "HEAD" request to "/queues/731d7bb8-6331-4ecf-95d9-804f7734e5e0" with headers "Accept: application/json, Host: localhost:1984"
