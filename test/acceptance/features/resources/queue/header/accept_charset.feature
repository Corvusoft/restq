...
Feature: Accept-Charset request-header field
    ...
    Scenario Outline: Valid accept-charset field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/1994df20-6d9e-40c4-81d8-d0124715763d" with headers "Accept: application/json, Accept-Charset: utf-8, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept-charset field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/61231dab-e2fb-419a-b676-a4b426794f99" with headers "Accept: application/json, Accept-Charset: iso-8859-5, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept-charset field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/fd72d8cc-c745-4458-b1ec-aa91af77c0fe" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
    ...
    Scenario Outline: Empty accept-charset field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/782c5408-31ac-4ba4-87c5-b920e1384fcd" with headers "Accept: application/json, Accept-Charset: , Host: localhost:1984"
        Then I should see a response status code of "406" "Not Acceptable"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "259"
    ...
    Scenario Outline: Wildcard accept-charset field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/9784c422-de2c-40e5-89a5-63f75c592fb2" with headers "Accept: application/json, Accept-Charset: *, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
