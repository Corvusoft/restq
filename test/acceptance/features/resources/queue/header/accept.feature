...
Feature: Accept request-header field
    ...
    Scenario Outline: Valid accept field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/aa4e8e34-7d77-49f9-a33d-02f0368ffc23" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/2ed5c55d-c2ba-4027-85a7-04fd11d6cc07" with header "Accept: application/bson, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/819fc37e-3f03-4f51-924a-0f8d216c25b2" with header "Host: localhost:1984"
        Then I should see a response status code of "406" "Not Acceptable"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "text/plain; charset=utf-8"
        And I should see a "Content-Length" header value "162"
    ...
    Scenario Outline: Empty accept field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/53c0ab62-4aad-49a7-a6b1-47872b029ced" with headers "Accept: , Host: localhost:1984"
        Then I should see a response status code of "406" "Not Acceptable"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "text/plain; charset=utf-8"
        And I should see a "Content-Length" header value "162"
    ...
    Scenario Outline: Wildcard accept field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/aa4e8e34-7d77-49f9-a33d-02f0368ffc23" with headers "Accept: */*, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
