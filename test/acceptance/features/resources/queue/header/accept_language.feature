...
Feature: Accept-Language request-header field
    ...
    Scenario Outline: Valid accept-language field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/69e4a13a-1e16-4b41-a035-b83b27d8759e" with headers "Accept: application/json, Accept-Language: en, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept-language field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/2c5b31c4-61eb-4c0b-898f-9bd234164e40" with headers "Accept: application/json, Accept-Language: es, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept-language field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/a335b7b9-baa0-41da-bbb5-1ddc7af3aa64" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "195"
    ...
    Scenario Outline: Empty accept-language field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/4c5d30bd-36a1-47a4-acc8-f4a67c50e5df" with headers "Accept: application/json, Accept-Language: , Host: localhost:1984"
        Then I should see a response status code of "406" "Not Acceptable"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "260"
    ...
    Scenario Outline: Wildcard accept-language field.
        ...
        """
        " { "data": {                                        "
        "     "key": "0081949d-88d3-42fe-a81c-d5f1338bf1da", "
        "     "name": "acceptance-test"                      "
        "   }                                                "
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/0081949d-88d3-42fe-a81c-d5f1338bf1da" with headers "Accept: application/json, Accept-Language: *, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "195"
