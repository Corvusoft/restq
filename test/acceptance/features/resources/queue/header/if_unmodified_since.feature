...
Feature: If-Unmodified-Since request-header field
    ...
    Scenario Outline: Date if-unmodified-since request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/ce7a8b33-f4ed-41c5-842d-f58057a5d112" with headers "Accept: application/json, Host: localhost:1984, If-Unmodified-Since: Sat, 29 Oct 1994 19:43:31 GMT"
    ...
    Scenario Outline: Malformed if-unmodified-since request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/5af60ed0-f8c0-4381-9a82-f767216225e8" with headers "Accept: application/json, Host: localhost:1984, If-Unmodified-Since: 3u9c8duco"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "285"
    ...
    Scenario Outline: Empty if-unmodified-since request-header field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/9666f2bb-bc2a-456b-9999-cd44e47f9e2e" with headers "Accept: application/json, Host: localhost:1984, If-Unmodified-Since: "
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "285"
