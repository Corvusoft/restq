...
Feature: Connection general-header field
    ...
    Scenario Outline: Keep-Alive connection field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/93e65d4c-c5e9-4bc0-a563-9f07be782031" with headers "Accept: application/json, Connection: keep-alive, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "265"
    ...
    Scenario Outline: Unknown connection field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/eaff2341-07b4-44f8-bac6-a5c175ddaee4" with headers "Accept: application/json, Connection: keep-closed, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "265"
    ...
    Scenario Outline: Abscent connection field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/a4c049fd-425c-4a35-a299-d8c00fbec06a" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "265"
    ...
    Scenario Outline: Empty connection field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/queues/62964311-ef74-4910-ab6d-a8b5b57b1a73" with headers "Accept: application/json, Connection: , Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "265"
