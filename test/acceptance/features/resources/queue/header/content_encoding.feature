...
Feature: Content-Encoding entity-header field
    ...
    Scenario Outline: Valid content-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/737644f9-a8a6-4eec-a427-d7a529412b14" with headers "Accept: application/json, Content-Encoding: identity, Host: localhost:1984"
    ...
    Scenario Outline: Invalid content-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/9ce7d5a5-fd23-4167-bf96-01f93fef7598" with headers "Accept: application/json, Content-Encoding: gzip, Host: localhost:1984"
    ...
    Scenario Outline: Abscent content-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/e854df51-8aa2-443b-a847-7e94d3febe18" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
    ...
    Scenario Outline: Empty content-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/1a7d7f18-5115-47ab-9503-12a76339b7d5" with headers "Accept: application/json, Content-Encoding: , Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
    ...
    Scenario Outline: Wildcard content-encoding field.
        ...
        " }                                                  "
        """
        When I perform a HTTP "GET" request to "/queues/54b53191-dc7a-4437-83bc-53c61d083ada" with headers "Accept: application/json, Content-Encoding: *, Host: localhost:1984"
        Then I should see a response status code of "200" "OK"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "178"
