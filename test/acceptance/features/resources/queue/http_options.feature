...
Feature: HTTP OPTIONS
    ...
    Scenario Outline: Read resource options.
        ...
        " }                                                  "
        """
        When I perform a HTTP "OPTIONS" request to "/queues/4b607477-bb7f-4081-829f-4764aaa40a91" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read non-existent resource options.
        Given I have started a message exchange
        When I perform a HTTP "OPTIONS" request to "/queues/d6e98fc5-98ad-4669-9c18-7294e2df6e87" with headers "Accept: application/json, Host: localhost:1984"
