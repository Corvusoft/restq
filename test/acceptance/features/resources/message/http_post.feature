...
Feature: HTTP POST
    ...
    Scenario Outline: Create resource.
        ...
        """
        When I perform a HTTP "POST" request to the last response "Location" header value with headers "Accept: application/json, Content-Type: text/ascii, Host: localhost:1984":
        """
        " More important data!!"
        """
    ...
    Scenario Outline: Create non-existent resource.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/messages/cb7254e7-7c00-49ed-a4f7-b1ae41706718" with headers "Accept: application/json, Content-Type: text/ascii, Host: localhost:1984":
        """
        " More important data!!"
        """
        Then I should see a response status code of "405" "Method Not Allowed"
