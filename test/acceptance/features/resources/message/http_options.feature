...
Feature: HTTP OPTIONS
    ...
    Scenario Outline: Read resource options.
        ...
        "     "key": "a3c4ce68-3fed-4225-ba77-025fb32f1bc5"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "a3c4ce68-3fed-4225-ba77-025fb32f1bc5" ] "
        "   }                                                      "
        " }                                                        "
        """
    ...
    Scenario Outline: Read non-existent resource options.
        Given I have started a message exchange
        When I perform a HTTP "OPTIONS" request to "/messages/f2ac27d9-63d1-4e4e-acfe-d821dd504832" with headers "Accept: application/json, Host: localhost:1984"
