...
Feature: Accept-Charset request-header field
    ...
    Scenario Outline: Valid accept-charset field.
        ...
        "     "key": "1bac5525-5af7-4a2c-87bd-aab46a44ac10"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "1bac5525-5af7-4a2c-87bd-aab46a44ac10" ] "
        "   }                                                      "
        " }                                                        "
        """
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Charset: utf-8, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept-charset field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "db69e20e-905b-4c06-9680-408693317bde"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "db69e20e-905b-4c06-9680-408693317bde" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Charset: iso-8859-5, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept-charset field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "1fae7d49-806f-4690-ae0f-2c953a1467e0"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "1fae7d49-806f-4690-ae0f-2c953a1467e0" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
    ...
    Scenario Outline: Empty accept-charset field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "7be48fd1-2874-46e2-9562-d6e0bdbb7bd4"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "7be48fd1-2874-46e2-9562-d6e0bdbb7bd4" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Charset: , Host: localhost:1984"
        Then I should see a response status code of "406" "Not Acceptable"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "259"
    ...
    Scenario Outline: Wildcard accept-charset field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "548f8521-4998-4ea0-b77a-0b433d9f5458"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "548f8521-4998-4ea0-b77a-0b433d9f5458" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
