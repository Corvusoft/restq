...
Feature: Accept-Encoding request-header field
    ...
    Scenario Outline: Valid accept-encoding field.
        ...
        "     "key": "97dc2da7-52f0-4025-8e03-da425acfc99e"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "97dc2da7-52f0-4025-8e03-da425acfc99e" ] "
        "   }                                                      "
        " }                                                        "
        """
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Encoding: identity, Host: localhost:1984"
    ...
    Scenario Outline: Invalid accept-encoding field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "452fb5ab-cb83-4792-8599-e7ca2c4a71cb"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "452fb5ab-cb83-4792-8599-e7ca2c4a71cb" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Encoding: gzip, Host: localhost:1984"
    ...
    Scenario Outline: Abscent accept-encoding field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "90c92d3b-ce5d-4fee-986c-1adbd00de6b5"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "90c92d3b-ce5d-4fee-986c-1adbd00de6b5" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
    ...
    Scenario Outline: Empty accept-encoding field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "ad0cd140-4713-471c-83b4-92c92577afdc"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "ad0cd140-4713-471c-83b4-92c92577afdc" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Accept-Encoding: , Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Allow" header value "OPTIONS"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: Wildcard accept-encoding field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "d728cbde-314b-49c8-8fdd-3957d2d4d31d"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "d728cbde-314b-49c8-8fdd-3957d2d4d31d" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
