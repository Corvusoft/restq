...
Feature: If-Range request-header field
    ...
    Scenario Outline: ETag if-range request-header field.
        ...
        "     "key": "0b472aa0-35b3-4dfd-8acc-36fc1dcb6000"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "0b472aa0-35b3-4dfd-8acc-36fc1dcb6000" ] "
        "   }                                                      "
        " }                                                        "
        """
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Host: localhost:1984, If-Range: "12978507194598101300", Range: bytes=3744-"
    ...
    Scenario Outline: Date if-range request-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "1f2f064c-50d0-4f7a-a600-010041b705c8"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "1f2f064c-50d0-4f7a-a600-010041b705c8" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Host: localhost:1984, If-Range: Sat, 29 Oct 1994 19:43:31 GMT, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Allow" header value "OPTIONS"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: Wildcard if-range request-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "53dc96b3-3c1d-40c6-8e6e-85e8290064f7"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "53dc96b3-3c1d-40c6-8e6e-85e8290064f7" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
        ...
        " Water level low. "
        """
        When I perform a HTTP "OPTIONS" request to the last response "Location" header value with headers "Accept: application/json, Host: localhost:1984, If-Range: *, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Allow" header value "OPTIONS"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: Empty if-range request-header field.
        ...
        " { "data": {                                        "
        "     "name": "acceptance test queue",               "
        "     "key": "4feb3971-8885-4028-acff-5e9f819d3962"  "
        "   }                                                "
        " }                                                  "
        """
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        ...
        "     "name": "acceptance test consumer",                  "
        "     "endpoint": "http://localhost:1985",                 "
        "     "queues": [ "4feb3971-8885-4028-acff-5e9f819d3962" ] "
        "   }                                                      "
        " }                                                        "
        """
        And I perform a HTTP "POST" request to "/messages" with headers "Content-Type: text/plain, Accept: application/json, Host: localhost:1984":
