...
Feature: HTTP PUT
    ...
    Scenario Outline: Update resource.
        ...
        "     "key": "ae856fdc-7f81-4be7-a3be-738d54383cfd"  "
        "   }                                                "
        " }                                                  "
        """
        ...
        "     "queues": [ "ae856fdc-7f81-4be7-a3be-738d54383cfd" ] "
        "   }                                                      "
        " } 
        """
        ...
        " power on"
        """
        When I perform a HTTP "PUT" request to the last response "Location" header value with headers "Accept: application/json, Content-Type: text/plain, Host: localhost:1984":
        """
        " power low "
        """
    ...
    Scenario Outline: Update non-existent resource.
        Given I have started a message exchange
        When I perform a HTTP "PUT" request to "/messages/931fd4a1-4142-49f9-a245-dc20c068d847" with headers "Content-Type: text/html, Accept: application/json, Host: localhost:1984":
        """
        " power off "
        """
        Then I should see a response status code of "405" "Method Not Allowed"
