...
Feature: Echo Cancellation
    ...
    Scenario Outline: Read collection.
        ...
        When I perform a HTTP "GET" request to "/subscriptions?echo=off" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read collection meta-data.
        Given I have started a message exchange
        When I perform a HTTP "HEAD" request to "/subscriptions?echo=on" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Create resource.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions?echo=no" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: HTTP error.
        Given I have started a message exchange
        When I perform a HTTP "CONNECT" request to "/subscriptions?echo=false" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984"
