...
Feature: Content-Type entity-header field
    ...
    Scenario Outline: Invalid content-type field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/xml, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
    ...
    Scenario Outline: Abscent content-type field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
    ...
    Scenario Outline: Empty content-type field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: , Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
