...
Feature: Expect request-header field
    ...
    Scenario Outline: Valid expect request-header field.
        ...
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Expect: 100-continue, Host: localhost:1984":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Invalid expect request-header field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Expect: %^&*&!@(]^%$, Host: localhost:1984":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
