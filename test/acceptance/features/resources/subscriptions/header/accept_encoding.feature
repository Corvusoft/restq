...
Feature: Accept-Encoding request-header field
    ...
    Scenario Outline: Valid accept-encoding field.
        ...
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Encoding: identity":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Invalid accept-encoding field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Encoding: gzip":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
    ...
    Scenario Outline: Empty accept-encoding field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Encoding: ":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
