...
Feature: Accept-Charset request-header field
    ...
    Scenario Outline: Valid accept-charset field.
        ...
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Charset: utf-8":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Invalid accept-charset field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Charset: iso-8859-5":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
    ...
    Scenario Outline: Empty accept-charset field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Accept-Charset: ":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
