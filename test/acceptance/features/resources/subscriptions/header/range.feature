...
Feature: Range request-header field
    ...
    Scenario Outline: HTTP GET range field.
        ...
        When I perform a HTTP "GET" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP HEAD range field.
        Given I have started a message exchange
        When I perform a HTTP "HEAD" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP CONNECT range field.
        Given I have started a message exchange
        When I perform a HTTP "CONNECT" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
    ...
    Scenario Outline: HTTP DELETE range field.
        Given I have started a message exchange
        When I perform a HTTP "DELETE" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
    ...
    Scenario Outline: HTTP PATCH range field.
        Given I have started a message exchange
        When I perform a HTTP "PATCH" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "501" "Not Implemented"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "206"
    ...
    Scenario Outline: HTTP PUT resource with no change required, range field.
        Given I have started a message exchange
        When I perform a HTTP "PUT" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Range: bytes=3744-, Host: localhost:1984":
        """
        " { "data": {                             "
    ...
    Scenario Outline: HTTP TRACE range field.
        Given I have started a message exchange
        When I perform a HTTP "TRACE" request to "/subscriptions" with headers "Accept: application/json, Range: bytes=3744-, Host: localhost:1984"
        Then I should see a response status code of "501" "Not Implemented"
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Content-Type" header value "application/json; charset=utf-8"
        And I should see a "Content-Length" header value "206"
    ...
    Scenario Outline: HTTP POST range field.
        Given I have started a message exchange
        When I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Range: bytes=3744-":
        """
        " { "data": {                                        "
        "     "endpoint": "http://localhost:8080"            "
        "   }                                                "
    ...
    Scenario Outline: HTTP OPTIONS range field.
        Given I have started a message exchange
        When I perform a HTTP "OPTIONS" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984, Range: bytes=3744-"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Allow" header value "GET,POST,HEAD,DELETE,OPTIONS"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Connection" header value "close"
