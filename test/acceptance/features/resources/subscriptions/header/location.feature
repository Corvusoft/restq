...
Feature: Location response-header field
    ...
    Scenario Outline: Create single resource.
        ...
        And I should see a "Location" header value "http://localhost:1984/subscriptions/53d2fcfe-3377-4d75-b1b8-6a50fd2615ef"
    ...
    Scenario Outline: Create multiple resources.
        ...
        """
        " { "data": [                                                                                 "
        "    { "key": "3e76a792-09d9-4bf9-9ffa-be1a371a2a22", "endpoint": "http://localhost:8080" },  "
        "    { "key": "36cc38de-4209-471d-b8da-9cdfa721be86", "endpoint": "http://localhost:8040" }   "
        "   ]                                                                                         "
        " }                                                                                           "
        """
        Then I should see a response status code of "201" "Created"
        ...
        And I should see a "Accept-Ranges" header value "none"
        And I should see a "Allow" header value "GET,PUT,HEAD,DELETE,OPTIONS"
        And I should see a "Location" header value "http://localhost:1984/subscriptions?keys=3e76a792-09d9-4bf9-9ffa-be1a371a2a22,36cc38de-4209-471d-b8da-9cdfa721be86"
        And I should not see a "WWW-Authenticate" header value
        And I should not see a "Trailer" header value
        And I should not see a "Warning" header value
        And I should not see a "Content-Range" header value
        ...
        """
        " { "data": [                                                                                                           "
        "     {  "type": "subscription", "endpoint": "http://localhost:8080", "key": "3e76a792-09d9-4bf9-9ffa-be1a371a2a22" },  "
        "     {  "type": "subscription", "endpoint": "http://localhost:8040", "key": "36cc38de-4209-471d-b8da-9cdfa721be86" }   "
        "   ]                                                                                                                   "
        " }                                                                                                                     "
        """
