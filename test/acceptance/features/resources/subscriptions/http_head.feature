...
Feature: HTTP HEAD
    ...
    Scenario Outline: Read collection meta-data with single entry.
        ...
        " }                                                  "
        """
        When I perform a HTTP "HEAD" request to "/subscriptions" with headers "Accept: application/json, Host: localhost:1984"
    ...
    Scenario Outline: Read collection meta-data with multiple entries.
        Given I have started a message exchange
        And I perform a HTTP "POST" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": {                                        "
    ...
    Scenario Outline: Read empty collection meta-data.
        Given I have started a message exchange
        When I perform a HTTP "HEAD" request to "/subscriptions" with headers "Accept: application/json, Host: localhost:1984"
        Then I should see a response status code of "204" "No Content"
        And I should see a "Server" header value "corvusoft/restq"
