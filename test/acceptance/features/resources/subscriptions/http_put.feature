...
Feature: HTTP PUT
    ...
    Scenario Outline: Update collection.
        Given I have started a message exchange
        When I perform a HTTP "PUT" request to "/subscriptions" with headers "Content-Type: application/json, Accept: application/json, Host: localhost:1984":
        """
        " { "data": [ {                           "
