...
Feature: Reserved words
    ...
    I want to reject certain keywords in resource definitions
    ...
    Scenario Outline: Create containing reserved keywords.
        ...
        And I should see a "Content-Length" header value "180"
        And I should see a "Server" header value "corvusoft/restq"
        And I should see a "Content-MD5" header value "c08de32879ee5fa70b4faf9a4241c679"
        ...
        "     "status": 400,                                                                                              "
        "     "title": "Bad Request",                                                                                     "
        "     "message": "The exchange is refusing to process the request because the body contains reserved properties." "
        "   }                                                                                                             "
        " }                                                                                                               "
        """
